<template>
    <div>
        ...
        <svg baseprofile="tiny" fill="#7c7c7c" height="615" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" version="1.2" viewbox="0 0 1100 400">
            ...
            <path d="M321.9 346.3 l 1 8.9 -0.1 4 -2.6 2.9 -1.5 2.7 -1.1 3.1 -0.5 2.6 -0.2 3.6 -12.1 -8.6 -2.3 -7.2 2 -11.9 8.1 -8.4 8.5 4.5z" style="fill=red;" id="HUN4925" name="Dunaújváros">
            </path>
            ...
            <defs>
                <clipPath id="sqsq">
                    <path d="M10 10 l30 0 0 30 -30 0 z" @click="square()"> </path>
                </clipPath>
            </defs>
            <defs>
                <clipPath id="sq">
                    <rect x="0" y="0" width="30" height="30" fill="red" />
                    <!-- <path d="M100 100 l30 0 0 30 -30 0 z" fill="red" @click="square()"> </path> -->
                </clipPath>
            </defs>
            ...
            <path d="M400 430 l30 0 0 30 -30 0 z" fill="red" @click="square()"> 
            <image
                    height="30px"
                    width="30px"
                    xlink:href="nuclear.png"
            ...
            <!-- <path d="M300.9 350.5 l -9.5 1.8 0 -8.5 -5.2 -3.6 -0.6 -13.4 11 -1.9 7.4 6.7 2.4 16.7 -5.5 2.2z" id="HUN4910" name="Zalaegerszeg">
            </path> -->
